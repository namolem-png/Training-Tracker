...
function build() {
    ...
    // Копируем файлы PWA (manifest.json, sw.js, icon-192.png, icon-512.png, favicon.png, favicon.ico)
    ['manifest.json', 'sw.js', 'icon-192.png', 'icon-512.png', 'favicon.png', 'favicon.ico'].forEach(file => {
